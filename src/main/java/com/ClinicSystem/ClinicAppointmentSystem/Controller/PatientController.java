...
public class PatientController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<PatientResponse> getById(@PathVariable Long id , Authentication authentication) {
        String email = authentication.getName();
        return ResponseEntity.ok(patientService.getPatientByIdForUser(id,email));
    }
